                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('updatePass') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex justify-content-end">
                                                    ...
                                                    <button type="reset" class="btn btn-danger waves-effect waves-light"><a href="{{ route('admin/profile') }}">Back</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
