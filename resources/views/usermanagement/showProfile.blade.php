                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a class="active" href="{{ url('admin/profile/') }}">Profile</a></li>
                                </ol>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="nav-first" role="tabpanel" aria-labelledby="nav-first-tab">
                                            ...
                                            <div class="text-center">
                                                <a href="{{ url('admin/profile/detail/'.$user->id) }}" class="text-warning btn-sm">Edit Profile</a>
                                                <a href="{{ url('admin/profile/changePassword/'.$user->id) }}" class="text-danger btn-sm">Change Password</a>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- end tab-content --}}
