                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table name="task" id="datatable" class="table table-bordered dt-responsive" 
                                    style="border-collapse: collapse; border-spacing: 0; width: 100%; font-size: 14px" data-cols-width="5,15,30,20,10,10,10,10,20,30">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="max-width: 8%" data-bs-toggle="tooltip" data-bs-placement="top" title="Member Name Assignee">Assignee</th>
                                            <th style="max-width: 10%" data-bs-toggle="tooltip" data-bs-placement="top" title="Status for each task">Status</th>
