                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a class="active" href="{{ url('member/task/') }}">Task</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="max-width: 15%" data-bs-toggle="tooltip" data-bs-placement="top" title="Name of Task">Task Name</th>
                                            <th style="max-width: 10%" data-bs-toggle="tooltip" data-bs-placement="top" title="Status of Task">Status</th>
                                            <th style="max-width: 8%" data-bs-toggle="tooltip" data-bs-placement="top" title="Work Durations (hour:minute)">Duration</th>
                                            <th hidden data-exclude="true">Duration</th>
                                            <th style="max-width: 12%" data-bs-toggle="tooltip" data-bs-placement="top" title="Dateline for each Task">Duedate</th>
                                            <th style="max-width: 20%" data-bs-toggle="tooltip" data-bs-placement="top" title="Notes for Task">Notes</th>
                                            <th style="max-width: 8%" data-bs-toggle="tooltip" data-bs-placement="top" title="Action for each Task" class="text-center" data-exclude="true">Modify</th>
                                        </tr>    
                                    </thead>
                                    ...
                                    @if ($item->user_id == $user->id)
                                        <tr>
                                            ...
                                            <td hidden class="project_id">{{ $item->project->id }}</td>
                                    ...
                                    <div class="col-12 d-flex mb-3">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">
                                            <a href="#" data-toggle="modal" data-target="#add_task"><i class="fa fa-plus"></i> Add Task</a>
                                        </button>
                                    </div>
                    ...
                    <form action="{{ route('member/task/update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row"> 
                            <div class="col-sm-6"> 
                                ...
                                <select class="form-control" name="project_id" id="e_project_id">
                                    {{-- <option selected disabled>{{ $project[0]->projectname }}</option> --}}
                                    @foreach ($project as $proyek)
                                    <option value="{{ $proyek->id }}">{{ $proyek->projectname }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-4"> 
                                <div class="form-group">
                                    <label>Work Durations (hour:minute)</label>
                                    <input required class="form-control" type="time" id="e_work_time" name="work_time" value="">
                                </div>
                            </div>
                            <div class="col-sm-4"> 
                                <div class="form-group">
