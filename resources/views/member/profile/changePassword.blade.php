                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ url('member/profile/') }}">Profile</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('member/updatePass') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex justify-content-end">
                                                    ...
                                                    <button type="reset" class="btn btn-danger waves-effect waves-light"><a href="{{ url('member/profile/') }}">Back</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
