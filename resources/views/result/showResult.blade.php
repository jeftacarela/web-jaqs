                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a class="active" href="{{ url('admin/result/') }}">Result</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th hidden data-exclude="true">User ID</th>
                                            <th hidden data-exclude="true">Project ID</th>
                                            <th style="max-width: 15%" data-bs-toggle="tooltip" data-bs-placement="top" title="Name of Project">Employee</th>
                                    ...
                                    @foreach ($results as $key => $result)
                                        <tr>
                                            ...
                                            <td hidden class="user_id">{{ $result->user_id }}</td>
                                            <td hidden class="project_id">{{ $result->project_id }}</td>
                                            <td class="projectname">{{ $result->name }}</td>
